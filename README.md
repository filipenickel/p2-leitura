O Readable é um app web que permite ao usuário adicionar posts e comentários a categorias pré-definidas, comentar nos posts, votar... //Aqui você continua :smile:
